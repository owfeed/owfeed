...
```sh
gh release download v0.5.3 -R owfeed/owfeed -p 'owfeed-linux-amd64'
...
In GitHub Actions, `owfeed/owfeed/setup@v0.5.3` does that verification for you. Builds exist for
...
```yaml
- uses: owfeed/owfeed/setup@v0.5.3       # installs owfeed v0.5.3
